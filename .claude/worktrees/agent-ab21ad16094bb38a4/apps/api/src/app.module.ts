...
// never a second write path for `exercise` — it has no mutation verb on it at all.
@Module({
  imports: [DrizzleModule, AuthModule, HealthModule, MailerModule, SyncModule, CatalogModule],
