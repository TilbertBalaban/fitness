...
2. If Context7 MCP is not available (custom subagents cannot see project-scoped
   `.mcp.json` servers — they only inherit user-scoped `/Users/tilbertbalaban/work/fitness/.claude/mcp.json`, so a
...
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/ios-scaffold.md
...
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/templates/summary.md
