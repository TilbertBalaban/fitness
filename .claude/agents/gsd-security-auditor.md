...
**Verification depth scales with `asvs_level`** (see @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
