...
<reference>
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/user-profiling.md` to load:
