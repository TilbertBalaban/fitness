...
ones). Reference: @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/tilbertbalaban/work/fitness/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/tilbertbalaban/work/fitness/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/tilbertbalaban/work/fitness/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/templates/spec.md.
