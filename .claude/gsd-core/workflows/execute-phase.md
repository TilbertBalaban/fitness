...
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/agent-contracts.md
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/context-budget.md
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/gates.md
</required_reading>
...
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/Users/tilbertbalaban/work/fitness/.claude/gsd-core/workflows/execute-plan.md` **inline**
...
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/execute-phase-wave-guard.md

@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/checkpoints.md
       @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/tdd.md
       @/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/executor-examples.md'}
       </execution_context>
...
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/execute-phase-quota-recovery.md

@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
**If gaps_found:**
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/offer-next.md
</step>
