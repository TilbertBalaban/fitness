...
- **Global scope**: `/Users/tilbertbalaban/work/fitness/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tilbertbalaban/work/fitness/.claude/notes/`)
...
2. Glob `/Users/tilbertbalaban/work/fitness/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tilbertbalaban/work/fitness/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tilbertbalaban/work/fitness/.claude/notes/` — works in any directory
