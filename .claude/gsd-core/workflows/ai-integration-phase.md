...
<required_reading>
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/ai-frameworks.md
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/tilbertbalaban/work/fitness/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/tilbertbalaban/work/fitness/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/tilbertbalaban/work/fitness/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/tilbertbalaban/work/fitness/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/tilbertbalaban/work/fitness/.claude/agents/gsd-eval-planner.md for instructions.
