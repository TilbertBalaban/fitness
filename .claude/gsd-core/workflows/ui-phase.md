...
```markdown
Read /Users/tilbertbalaban/work/fitness/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/tilbertbalaban/work/fitness/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/tilbertbalaban/work/fitness/.claude/agents/gsd-ui-checker.md for instructions.
...
@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/tilbertbalaban/work/fitness/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/tilbertbalaban/work/fitness/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/tilbertbalaban/work/fitness/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
