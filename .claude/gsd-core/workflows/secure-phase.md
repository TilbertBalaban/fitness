...
```
Agent(
  prompt="Read /Users/tilbertbalaban/work/fitness/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tilbertbalaban/work/fitness/.claude/gsd-core/templates/SECURITY.md`
