...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/tilbertbalaban/work/fitness/.claude
                  → checks /Users/tilbertbalaban/work/fitness/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/tilbertbalaban/work/fitness/.claude/gsd-core
                  → writes to /Users/tilbertbalaban/work/fitness/.claude/gsd-core/hooks/
