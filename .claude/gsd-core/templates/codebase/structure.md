...
- Usage: Reference from command with `@/Users/tilbertbalaban/work/fitness/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/tilbertbalaban/work/fitness/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/tilbertbalaban/work/fitness/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
