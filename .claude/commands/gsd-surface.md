...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/tilbertbalaban/work/fitness/.claude/.gsd-surface.json`
(sibling to `/Users/tilbertbalaban/work/fitness/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/tilbertbalaban/work/fitness/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/tilbertbalaban/work/fitness/.claude/skills`).
...
`/Users/tilbertbalaban/work/fitness/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/tilbertbalaban/work/fitness/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/tilbertbalaban/work/fitness/.claude/.gsd-surface.json`
Install profile marker: `/Users/tilbertbalaban/work/fitness/.claude/.gsd-profile`
Skill dirs: `/Users/tilbertbalaban/work/fitness/.claude/skills/gsd-*/`
Engine module: `/Users/tilbertbalaban/work/fitness/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/tilbertbalaban/work/fitness/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
