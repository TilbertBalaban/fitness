...
test('finishing a workout with a new PR shows the badge, and correcting the set below the prior best removes it', async ({ page }) => {
  ...
  // Corrects the set down to 80kg, below the seeded 90kg prior best — the badge must disappear on
  // the very next render, without the row just asserted above ever being deleted (D-30/LOG-19's
