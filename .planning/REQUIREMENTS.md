...
- [x] **LOG-11**: User sees a workout duration timer running for the session
...
- [x] **LOG-14**: User can add, swap, or remove exercises mid-workout
...
- [x] **GYM-01**: User can create multiple gym profiles and pick which is active
- [x] **GYM-02**: User can configure a profile's bar types and weights, available plate denominations and counts, and unit system
- [x] **GYM-03**: User can configure machine availability, weight-stack ranges, and any built-in starting resistance
- [x] **GYM-04**: User can assign a gym profile to a workout and switch gyms mid-program
...
- [x] **GYM-07**: User can mark equipment unavailable mid-workout and be offered alternatives
...
- [x] **ANLY-04**: User can see set volume per muscle group on a front/back body-map heatmap over a selectable window (1 week / 1 month / 3 months)
- [x] **ANLY-05**: User can drill into a muscle group to see which exercises contributed its sets
...
- [x] **ANLY-09**: User's PRs and volume figures are recomputed correctly when they edit a past workout
...
- [x] **BODY-03**: User can view measurement and bodyweight trends
- [x] **BODY-04**: User can capture and store progress photos
- [x] **BODY-05**: User can generate a before-and-after photo composite

### Dashboard

- [x] **DASH-01**: User sees a dashboard with weekly progress, recent records, and insight tiles
- [x] **DASH-02**: User can add, remove, and reorder dashboard widgets
- [x] **DASH-03**: User can reach high-frequency actions (quick weigh-in, measurement, progress photo, history, new program, one-off workout) from a single quick-action menu
...
| LOG-11 | Phase 5 — In-Gym Session Logging | Complete |
| LOG-12 | Phase 5 — In-Gym Session Logging | Complete |
| LOG-13 | Phase 5 — In-Gym Session Logging | Complete |
| LOG-14 | Phase 5 — In-Gym Session Logging | Complete |
...
| GYM-04 | Phase 6 — Gym Profiles & Plate Math | Complete |
...
| BODY-05 | Phase 12 — Body Metrics & Dashboard | Complete |
| DASH-01 | Phase 12 — Body Metrics & Dashboard | Complete |
| DASH-02 | Phase 12 — Body Metrics & Dashboard | Complete |
| DASH-03 | Phase 12 — Body Metrics & Dashboard | Complete |
