...
number: 1
name: SECURITY — signed-out direct-URL access to the exercises segment
expected: |
  While signed out, loading /exercises/seed_90_90_Hamstring, /exercises/new and
  /exercises/edit/seed_90_90_Hamstring directly by URL redirects to sign-in / does not
  mount protected content — matching the existing behavior of /exercises.
